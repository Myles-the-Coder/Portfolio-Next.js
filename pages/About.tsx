		...
		<Box as='section' id='about'>
			...
			<Box className='about-desc'>
				<Text data-aos='fade-left' data-aos-duration='1100'>
					Hello, my name is Myles Jefferson. I am a self-taught developer with a passion for building elegant and user-friendly applications. Starting from humble beginnings, I spent time honing my skills in HTML, CSS/SCSS, TypeScript, React, NextJS, NodeJS servers, Redux, Git, API development, SQL, and noSQL. In my professional
					experience, I have spent over a year working on a variety of projects, from small web applications to large-scale enterprise systems. I have been
					...
					of quality. Through this work, I have also become comfortable with Docker, Azure DevOps, Linux servers, agile development methodologies, test-driven development, and continuous
			...
			<a href='https://docdro.id/cTkg7TC' rel='noreferrer'>
